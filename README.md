...
* Scheme Fees Collateral - Scheme operator entity used for Scheme Fee collateral
...
> The following event occurs outside the Scheme hub.
```
DR Bank                               120
...
-OLD--    CR Scheme Fees Collateral                                10
```
###
...
### Entities
* Scheme Fees Liquidity - Fees being charged by the Scheme
...
* SF's Scheme Fees Liquidity has a net CR balance of;  `0 + 10 = 10`
...
* Scheme Recon SR - Scheme Reconciliation (Scheme operator)

#### 1. Transfer Settlement Reservation (On Payer) and Scheme Recon:
